...
from core.views import index, clientes, locacoes
from core.views import remover_cliente, remover_locacao
from core.views import atualiza_cliente
from core.views import  atualiza_locacao
